...
const ImageUploader = ({
  ...
  return (
    <div className="max-w-2xl mx-auto p-6 bg-white rounded-lg shadow-md">
      ...
      {/* Upload area */}
      <div
        className="border-2 border-dashed border-sec-main rounded-lg p-8 text-center mb-6 cursor-pointer hover:bg-sec-main/10 transition-colors"
      ...
      >
        ...
        />
        <svg
          className="h-12 w-12 text-sec-main mx-auto mb-4"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
