...
import type { Product, ProductBrand, ProductImage } from "@prisma/client";
import { useRouter, useSearchParams } from "next/navigation";

type TheProduct = Product & {
  brand: {
    name: string;
    id: string;
  };
...
export default function Product({ products, brands, counts }: ProductProps) {
  ...
  const currentPage = products?.currentPage ?? 0;
            ...
            <CardContent className="p-4">
              <div className="flex items-center justify-between">
                <p className="text-sm text-gray-600">
                  ...
                  {counts.totalCount} total products)
                </p>
                <div className="flex items-center gap-2">
                  <Button
                    variant="outlined"
