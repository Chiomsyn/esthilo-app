    ...
    <div className="bg-gray-100 mx-auto px-4 sm:px-6 lg:px-8 py-8 ">
      <div className="">
        <div className="flex-gap flex-col md:flex-row gap-4">
          ...
          <p className="bg-sec-main/60 w-fit text-white px-3 py-0.5 rounded font-semibold text-xs">
            {paymentMethod}
          </p>
        </div>
        ...
        <div className="grid py-10 md:grid-cols-3 gap-7 lg:gap-0 relative">
          ...
          <div className="flex items-center relative md:items-start flex-col gap-2">
            <div className="p-1 bg-sec-main rounded-full">
            ...
            <div className="">
              ...
              <div className="mt-2">
                {isDelivered ? (
                  ...
                  <Badge
                    variant="destructive"
                    className="text-xs text-red-500 bg-red-500"
                  >
                    Not Delivered
                  </Badge>
                )}
        ...
        <div className="mx-auto mt-4 max-w-6xl rounded bg-white">
