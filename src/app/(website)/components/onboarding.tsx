...
const Onboarding = () => {
  ...
  return (
    <div className="w-full bg-white">
      <div className="flex max-w-[1280px] mx-auto h-fit bg-white">
        {onboardingInfo.map((info, index) => (
          <div
            key={index}
            className={`w-full ${
              index === currentIndex ? "block" : "hidden"
            } grid lg:grid-cols-2 lg:h-[800px] gap-10 `}
          >
            <div className="flex flex-col items-start lg:justify-center px-4 lg:px-0 ">
              <div className="w-full flex flex-col gap-10">
                <div className="l lg:gap-10 gap-5 flex flex-col">
                  ...
                  <Button
                    size="lg"
                    type="submit"
                    className=" bg-base-color max-w-[200px] text-white"
                  >
                    Shop Now
                  </Button>
                </div>
