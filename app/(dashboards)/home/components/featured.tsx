      ...
      <div className="mt-5 hidden md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5">
        {Array(8)
          ...
          .map((e: any, i: number) => (
            <div
              key={i}
              className="w-[300px] relative group hover:ring-2 hover:ring-secondary-color rounded-md shadow-sm border-white drop-shadow-sm bg-slate-50 border-2 flex flex-col items-center pt-3"
            >
              <Image
              ...
              <div className="w-full flex flex-col gap-1 pr-1 pl-5 pt-5 pb-1">
                ...
                <div className="self-end cursor-pointer  hover:bg-gray-500 text-white rounded-tl-3xl rounded-br-[24px] p-3 bg-black">
