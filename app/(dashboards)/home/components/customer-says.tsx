...
const CustomerSays = () => {
  return (
    <div className="relative flex flex-col lg:flex-row gap-5 xl:gap-10 item-center justify-center px-5 lg:px-10 xl:px-20 py-10 lg:py-32 bg-tertiary-color">
      ...
      <div className="hidden lg:flex gap-5 mt-10 self-start items-center ">
      ...
      <div className="animate-fadeIn w-fit lg:w-[600px] z-10 shadow-md lg:gap-10 bg-white gap-5 flex flex-col p-10">
        <QuotesIcon className="text-secondary-color" size={40}/>
      ...
      <div className="absolute right-0 lg:h-full h-[50%] w-[40%] lg:top-0 bottom-0  rounded-l-full bg-secondary-color ">
      </div>    
    </div>
  );
};
